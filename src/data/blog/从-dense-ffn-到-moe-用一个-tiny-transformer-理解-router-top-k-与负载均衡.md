...
完整源码可以在 GitHub 查看：[examples/tiny-moe/tiny_moe.py](https://github.com/SonglinLife/my-blog/blob/117ea426cafb59faa797ea6094576c65c3084470/examples/tiny-moe/tiny_moe.py)。需要直接运行时，也可以[下载原始 Python 文件](https://raw.githubusercontent.com/SonglinLife/my-blog/117ea426cafb59faa797ea6094576c65c3084470/examples/tiny-moe/tiny_moe.py)。两个链接都固定在本文首次发布的 commit，不会随 `main` 后续修改而漂移。
